...
const Footer = () => {
  return (
   ...
   <style>{`
    ...
    <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-linear-to-r from-white via-indigo-200/60 to-white mt-40">
                ...
                <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
                    <p className="max-w-60">Making every candidate feel valued. Be the one in a million.</p>
                    <div className="flex items-center gap-4 mt-3">
                        ...
                        <a href="https://www.linkedin.com/in/veena-sahu2512" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://x.com/Veena__Sahu" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://www.youtube.com/@veenasahu4528" target="_blank" rel="noreferrer">
                    ...
                    <p className="mt-3 text-center">VeenaSahu © 2026 Resume Builder</p>
                </div>
     </footer>
