  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <p className='text-2xl font-medium mb-6 bg-linear-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden '>Welcome to your dashboard!</p>
            ...
            <div onClick={e=> e.stopPropagation()} className='realtive bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <div>
                <label htmlFor="resume-input" className="block text-sm text-slate-700"> 
                  Select Resume file
                <div className= "flex flex-col items-center justify-center gap-2 border group text-slate-400 border-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-indigo-500 hover:text-indigo-700 cursor-pointer transition-colors" onChange={(e)=>setResume(e.target.files?.[0] || null)}>
                  {resume ? (
                    <p className='text-sm text-indigo-700'>{resume.name}</p>
                  ) : (
                    <> 
