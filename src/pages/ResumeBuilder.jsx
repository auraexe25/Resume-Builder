...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, FileText, FolderIcon, GraduationCap, Sparkles, User } from 'lucide-react' // FIX: Added missing import
...
const ResumeBuilder = () => {
  ...
  // FIX: Removed 'params' argument since it wasn't used
          ...
          {/*Form Content*/}
              <div className='space-y-6'>
                {activeSection.id=== 'personal' && (
                  <PersonalInfoForm data={resumeData.personal_info} onChange={(updatedInfo)=> setResumeData(prev=> ({...prev, personal_info: updatedInfo}))} removeBackground={removeBackground} setRemoveBackground={setRemoveBackground}/>
                )}
