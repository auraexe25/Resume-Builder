...
const Testimonial = () => {
  ...
  return (
    ...
    <div id='testimonials' className="flex flex-col items-center my-10 scroll-mt-12">
          <div className="flex items-center gap-2 text-sm text-indigo-800 bg-blue-400/10 rounded-full px-6 py-2">
            <BookUser className='size-4.5 stroke-indigo-600' />
            <span>Testimonials</span>
    </div>
    <Title title="Don't just take our words" description="Hear what users say about us. We're always looking for ways to improve. If you have a positive experience, please share it with us.  " />
    </div>
